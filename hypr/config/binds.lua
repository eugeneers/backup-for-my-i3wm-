...
hl.bind(mainMod .. " + ALT + L",    hl.dsp.exec_cmd(noctCall .. "session lock && systemctl suspend"))
...
hl.bind(mainMod .. " + F2", hl.dsp.exec_cmd(noctCall .. "volume-up"),   { locked = true, repeating = true })
hl.bind(mainMod .. " + F3", hl.dsp.exec_cmd(noctCall .. "volume-down"), { locked = true, repeating = true })
...
hl.bind(mainMod .. " + F4",      hl.dsp.exec_cmd(noctCall .. "brightness-up"),   { locked = true, repeating = true })
hl.bind(mainMod .. " + F5",      hl.dsp.exec_cmd(noctCall .. "brightness-down"), { locked = true, repeating = true })
...
hl.bind("Print",
    hl.dsp.exec_cmd([[bash -c 'mkdir -p ~/Pictures/Screenshots && grim -g "$(slurp)" ~/Pictures/Screenshots/$(date +%Y-%m-%d_%H-%M-%S).png']])
)

hl.bind(mainMod .. " + Print",
    hl.dsp.exec_cmd([[bash -c 'mkdir -p ~/Pictures/Screenshots && grim ~/Pictures/Screenshots/$(date +%Y-%m-%d_%H-%M-%S).png']])
)
