...
hl.on("hyprland.start", function () 
	hl.exec_cmd("swaybg -i  /home/eres/Pictures/wall1.jpg")
...
hl.bind(main_mod .. " + ALT + L", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
hl.bind(main_mod .. " + SHIFT + F", hl.dsp.exec_cmd(fileManager))
...
hl.bind(main_mod .. " + L",  hl.dsp.focus({ direction = "left" }))
hl.bind(main_mod .. " + H", hl.dsp.focus({ direction = "right" }))
