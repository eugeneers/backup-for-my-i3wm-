-- Environmental variables (for reference https://wiki.hypr.land/Configuring/Advanced-and-Cool/Environment-variables/) if you use UWSM, define your variables in ~/.config/uwsm/env
